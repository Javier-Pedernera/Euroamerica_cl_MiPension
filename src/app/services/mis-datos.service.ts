...
export class MisDatosService {
  ...
  //produccion
  urlConsulta = 'http://rrvv.euroamerica.cl/WA_RRVV/rest/usuario/consultar-mis-datos';
  urlActualizar = 'http://rrvv.euroamerica.cl/WA_RRVV/rest/usuario/actualizar-mis-datos';
